...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findLatestByLabelId(String labelId, int page, int size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		return problemDao.findLatestByLabelId(labelId, pageable);
	}
	 ...
	 * @return
	 */
	public Page<Problem> findHottestByLabelId(String labelId, int page, int size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		return problemDao.findHottestByLabelId(labelId, pageable);
	}
	 ...
	 * @return page
	 */
	public Page<Problem> findWaitedByLabelId(String labelId, int page, int size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		return problemDao.findHottestByLabelId(labelId, pageable);
	}
